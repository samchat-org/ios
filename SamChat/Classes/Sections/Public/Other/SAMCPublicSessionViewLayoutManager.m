//
//  SAMCPublicSessionViewLayoutManager.m
//  SamChat
//
...
@interface SAMCPublicSessionViewLayoutManager()<NIMInputDelegate>

@property (nonatomic,weak) SAMCPublicInputView *inputView;
...
@implementation SAMCPublicSessionViewLayoutManager
