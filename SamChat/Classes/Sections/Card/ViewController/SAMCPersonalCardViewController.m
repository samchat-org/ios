//
//  SAMCPersonalCardViewController.m
//  SamChat
//
...
@interface SAMCPersonalCardViewController ()
...
@implementation SAMCPersonalCardViewController
...
- (void)chat{
    ...
    SAMCSession *session = [SAMCSession session:self.userId type:NIMSessionTypeP2P mode:mode];
