...
@interface SAMCCustomContactCell ()
...
@implementation SAMCCustomContactCell
...
- (void)setupSubviews
{
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-10-[_avatarView(50)]-20-[_nameLabel]"
                                                                 options:0
                                                                 metrics:nil
